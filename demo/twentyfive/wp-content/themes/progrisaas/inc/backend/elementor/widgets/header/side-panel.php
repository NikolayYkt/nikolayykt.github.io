 ...
 */
class ProgriSaaS_Sidepanel extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Side Panel', 'progrisaas' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'style_panel_section',
			[
				'label' => __( 'Side Panel', 'progrisaas' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'bg_close',
			[
				'label' => __( 'Background Close Button', 'progrisaas' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'color_close',
			[
				'label' => __( 'Color Close Button', 'progrisaas' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the ProgriSaaS_Sidepanel class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_Sidepanel() );