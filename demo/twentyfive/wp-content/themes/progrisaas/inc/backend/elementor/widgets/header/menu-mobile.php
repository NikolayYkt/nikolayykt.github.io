 ...
 */
class ProgriSaaS_Menu_Mobile extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Menu Mobile', 'progrisaas' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .mmenu-wrapper .mobile_mainmenu li a, {{WRAPPER}} .mmenu-wrapper .mobile_mainmenu > li .arrow' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'color_back',
			[
				'label' => __( 'Back Button Color', 'progrisaas' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the ProgriSaaS_Menu_Mobile class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_Menu_Mobile() );