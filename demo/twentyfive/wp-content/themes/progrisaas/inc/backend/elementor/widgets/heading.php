 ...
 */
class ProgriSaaS_Heading extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Heading', 'progrisaas' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'sub',
			[
				'label' => __( 'Subtitle & Title', 'progrisaas' ),
...
// After the ProgriSaaS_Heading class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_Heading() );