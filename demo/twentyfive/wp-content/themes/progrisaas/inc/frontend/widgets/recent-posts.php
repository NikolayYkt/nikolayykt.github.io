...
class progrisaas_recent_news extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__('OT Recent Posts', 'progrisaas'), 

            // Widget description
            array( 'description' => esc_html__( 'OT Recent Posts', 'progrisaas' ), ) 
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Latest News', 'progrisaas' ) : $instance['title'], $instance, $this->id_base );
    ...
    // Check values
    	 ...
    	 $title = isset( $instance['title'] ) ? $instance['title'] : esc_html( 'Latest News', 'progrisaas' );
    ...
    <p>
        <label><?php esc_html_e( 'Title:', 'progrisaas' ); ?></label>

        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
    </p>
    <p>

        <label><?php esc_html_e( 'Number of posts to show:', 'progrisaas' ); ?></label> 
    ...
    <p>
        <label>
            ...
            <?php esc_html_e( 'Show date time', 'progrisaas' ); ?>
        </label>
    </p>
...
function progrisaas_wpb_recent_news() {
	register_widget( 'progrisaas_recent_news' );
}
add_action( 'widgets_init', 'progrisaas_wpb_recent_news' );