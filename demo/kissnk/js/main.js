...
(function ($) {
	...
	$.scrollUp({
        ...
        $('.main-cat-2').click(function(){
            ...
            $(".cat--2").removeClass("cat-hidden");
            $(".main-cat-2").removeClass("main-cat-2");
        });

        $('.main-cat-3').click(function(){

            $(".cat--3").css({ display: "block" });
            $(".cat--3").removeClass("cat-hidden");
            $(".main-cat-3").removeClass("main-cat-3");
        });

        $('.main-cat-4').click(function(){

            $(".cat--4").css({ display: "block" });
            $(".cat--4").removeClass("cat-hidden");
            $(".main-cat-4").removeClass("main-cat-4");
        });
