 ...
 */
class ProgriSaaS_CountDown extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT CountDown', 'progrisaas' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'zone',
			[
				'label' => __( 'UTC Timezone Offset', 'progrisaas' ),
				'type' => Controls_Manager::NUMBER,
				'default' => __( '0', 'progrisaas' ),
			]
		);
		...
		$this->start_controls_tab(
			'tab_title_normal',
			[
				'label' => __( 'One', 'progrisaas' ),
			]
		);
		$this->add_control(
			'day',
			[
				'label' => __( 'Day', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Day', 'progrisaas' ),
			]
		);
		$this->add_control(
			'hour',
			[
				'label' => __( 'Hour', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Hour', 'progrisaas' ),
			]
		);
		$this->add_control(
			'min',
			[
				'label' => __( 'Minute', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Minute', 'progrisaas' ),
			]
		);
		$this->add_control(
			'second',
			[
				'label' => __( 'Second', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Second', 'progrisaas' ),
			]
		);
		...
		$this->start_controls_tab(
			'tab_title_active',
			[
				'label' => __( 'Multi', 'progrisaas' ),
			]
		);
		$this->add_control(
			'days',
			[
				'label' => __( 'Days', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Days', 'progrisaas' ),
			]
		);
		$this->add_control(
			'hours',
			[
				'label' => __( 'Hours', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Hours', 'progrisaas' ),
			]
		);
		$this->add_control(
			'mins',
			[
				'label' => __( 'Minutes', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Minutes', 'progrisaas' ),
			]
		);
		$this->add_control(
			'seconds',
			[
				'label' => __( 'Seconds', 'progrisaas' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Seconds', 'progrisaas' ),
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Text Shadow', 'progrisaas' ),
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'sepe_typography',
				'selector' => '{{WRAPPER}} .ot-countdown li.seperator',
			]
		);
		$this->add_control(
			'sepe_color',
...
// After the ProgriSaaS_CountDown class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_CountDown() );