 ...
 */
class ProgriSaaS_Image_Gallery extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Image Gallery', 'progrisaas' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Image Gallery', 'progrisaas' ),
			]
		);
		$this->add_control(
			'image_gallery',
			[
				'label' => __( 'Add Images', 'progrisaas' ),
		...
		$this->add_responsive_control(
			'image_spacing',
			[
				'label' => __( 'Image Spacing', 'progrisaas' ),
...
// After the ProgriSaaS_Image_Gallery class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_Image_Gallery() );