 ...
 */
class ProgriSaaS_Pricing_Table extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Pricing Table', 'progrisaas' );
	}
...
// After the ProgriSaaS_Pricing_Table class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_Pricing_Table() );