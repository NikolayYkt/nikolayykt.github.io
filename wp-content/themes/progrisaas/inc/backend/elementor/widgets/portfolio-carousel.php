 ...
 */
class ProgriSaaS_Portfolio_Slider extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Portfolio Carousel', 'progrisaas' );
	}
...
// After the ProgriSaaS_Portfolio_Slider class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_Portfolio_Slider() );