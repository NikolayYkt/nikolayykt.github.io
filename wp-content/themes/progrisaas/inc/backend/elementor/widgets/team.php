 ...
 * Widget Name: Team 3
 */
class ProgriSaaS_Team extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Member Team', 'progrisaas' ),
			]
		);
		...
		$this->add_control(
	       'member_image',
	        [
	            'label' => esc_html__( 'Photo', 'progrisaas' ),
	    ...
	    $this->add_control(
		    'member_name',
	      	[
	          	'label' => esc_html__( 'Name', 'progrisaas' ),
	          	'type'  => Controls_Manager::TEXT,
				'default' => esc_html__( 'Peter Perish', 'progrisaas' ),
	    	]
	    );
	    ...
	    $this->add_control(
		    'member_extra',
	      	[
	          	'label' => esc_html__( 'Extra/Job', 'progrisaas' ),
	          	'type'  => Controls_Manager::TEXTAREA,
	          	'default' => esc_html__( 'co-founder of company', 'progrisaas' ),
	    	]
	    );
	    $this->add_control(
		    'member_desc',
	      	[
	          	'label' => esc_html__( 'Description', 'progrisaas' ),
	          	'type'  => Controls_Manager::TEXTAREA,
	          	'default' => '',
	    	]
	    );
		...
		$repeater->add_control(
		    ...
		    [
		        'label'   => esc_html__( 'Name', 'progrisaas' ),
		        'type'    => Controls_Manager::TEXT,
		        'default' => esc_html__( 'Social', 'progrisaas' ),
		    ]
	    );
        ...
        $repeater->add_control(
            'social_icon',
            [
                'label' => esc_html__( 'Icon', 'progrisaas' ),
        ...
        $repeater->add_control(
            'social_link',
            [
                'label' => esc_html__( 'Link', 'progrisaas' ),
                'type'  => Controls_Manager::URL,
                'dynamic' => [
					'active' => true,
				],
				'placeholder' => __( 'https://', 'progrisaas' ),
				'default' => [
					'url' => 'https://', 
				],
            ]
		...
		$this->add_control(
		    'social_share',
		    [
		        'label'       => esc_html__( 'Socials', 'progrisaas' ),
		        'type'        => Controls_Manager::REPEATER,
		        'show_label'  => true,
		        'default'     => [
		            [
		             	'title'       => esc_html__( 'Facebook', 'progrisaas' ),
		                'social_link' => esc_html__( 'https://www.facebook.com/', 'progrisaas' ),
		                'social_icon' => [
		            ...
		            [
		             	'title'       => esc_html__( 'Instagram', 'progrisaas' ),
		                'social_link' => esc_html__( 'https://www.instagram.com/', 'progrisaas' ),
		                'social_icon' => [
		            ...
		            [
		             	'title'       => esc_html__( 'Linkedin', 'progrisaas' ),
		                'social_link' => esc_html__( 'https://www.linkedin.com/', 'progrisaas' ),
		                'social_icon' => [
		...
		$this->add_control(
			'link',
			[
				'label' => __( 'Link To Details', 'progrisaas' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'https://', 'progrisaas' ),
			]
		);
		...
		$this->add_control(
			'position',
			[
				'label' => __( 'Image Position', 'progrisaas' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.ot-position-right .ot-team__thumb' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.ot-position-left .ot-team__thumb' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.ot-position-top .ot-team__thumb' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'(mobile){{WRAPPER}} .ot-team__thumb' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .effect-thumb' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'is_effect',
			[
				'label'   => esc_html__( 'Hover Effect', 'progrisaas' ),
		...
		$this->add_control(
			'effect_color',
			[
				'label'     => esc_html__( 'Border Color', 'progrisaas' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .effect-thumb' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'is_effect'	=> 'yes'
				]
		...
		$this->start_controls_section(
			'info_style',
			[
				'label' => esc_html__( 'Info Box', 'progrisaas' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'title_hcolor',
			[
				'label'     => esc_html__( 'Color Hover', 'progrisaas' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .ot-team__info h5 a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .ot-team__info h5 a' => 'background-image: linear-gradient(0deg, #e9e9e9, {{VALUE}});',
				],
				'condition' => [
					'link[url]!'  => ''
				]
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'progrisaas' ),
		...
		$this->add_responsive_control(
			'icon_social_size',
			[
				'label' => esc_html__( 'Size', 'progrisaas' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 5,
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'team-box' ); ?>>
			<div class="ot-team__thumb">
				...
				<?php if( $settings['is_effect'] ){ ?><div class="effect-thumb"></div><?php } ?>
			</div>
...
// After the ProgriSaaS_Team class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new ProgriSaaS_Team() );